        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                await _emailSender.SendEmailAsync(
                    Input.NewEmail,
                    "Xác nhận Email",
                    $"Làm ơn xác nhận tài khoản <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>nhấp vào đây</a>.");

                StatusMessage = "Đã gửi thông tin xác thực vui lòng truy cập Email kích hoạt";
